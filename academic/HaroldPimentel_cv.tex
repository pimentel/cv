...
\address{\centerline{\large Postdoctoral researcher\vspace*{0.4in}}\\\centerline{\large HHMI Hanna H. Gray fellow}}
...
\item Thesis: Fast and accurate quantification and differential analysis of transcriptomes.
...
\section{\sc Employement History}
...
Interested in human gene regulation.
Approaches include: intron retention QTL method development, modeling of targeted perturbations, trans QTL analysis.
...
\hlpub Denotes selected publication.
...
\hlpub\underline{H. Pimentel}, M. Parra, S. Gee, D. Ghanem, X. An, J. Li, N.
...
Transitional award (\$1.4M over 8 years)
...
Alex Tseng (Undergraduate; August 2015 - Present) has been working on improving effective length estimation in RNA-Seq transcript quantification.
